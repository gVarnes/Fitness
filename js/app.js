...
let slider_propose = new Swiper('.slider-propose__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let slider_coaches = new Swiper('.slider-coaches__row', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.arrows-coaches .arrows-coaches_next',
		prevEl: '.arrows-coaches .arrows-coaches_prev',
	},
